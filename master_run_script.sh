...
(cd PalindromeFinder && srun -p GPU --mem=50G -c spark-submit --driver-memory 50G --class PalindromeFinder target/scala-2.10/palindromefinder_2.10-0.1.jar file://`pwd`/$f $minimum)
